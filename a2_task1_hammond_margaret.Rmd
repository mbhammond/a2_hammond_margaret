...
Model 1 was able to predict INLINE CODE correct for ***Serenoa repens*** and INLINE CODE for ***Sabal etonia***. Model 1 was able to predict the plant species based off of the predictor variables relatively well.

lp classify species correctly?
